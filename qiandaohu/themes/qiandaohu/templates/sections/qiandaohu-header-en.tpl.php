  ...
  <div class="container">
    <nav class="nav">
      <ul class="mainNav clearfix">
        ...
        <li>
          <a href="<?php print url('registration-guidelines.html'); ?>">REGISTRATION<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">REGISTRATION
            <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="<?php print url('registration-guidelines.html'); ?>">Registration Guidelines</a></li>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">RESULT AND PHOTO
            <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="<?php print url('result.html'); ?>">Query Result</a></li>
            <li><a href="<?php print url('photos.html'); ?>">Photos</a></li>
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">SPONSOR
            <span class="caret"></span></a>
          <ul class="dropdown-menu">
